...
# 100 test sulla logica core (sort_by_attribute, sort_by_centroid, sort_multi, robustezza geometrie NULL, ecc.)
```
...
# Output: 147 tests (100 ok, 47 skipped che richiedono QGIS)
```
